...
This project documents my setup process and exploration of AI-powered tools for improving productivity and workflow as a Growth Marketing professional.

The objective of this project is to understand how modern AI tools can support research, analysis, documentation, and problem-solving workflows.
...
### Challenge 1: Understanding Cursor interface

Problem: The Cursor UI difference between the current version and the tutorial version on Youtube, leading to the misunderstanding of Extensions and Plugins feature in integrating Claude Code and Codex process
...
- How AI tools can accelerate workflows.
- How to document a project clearly.
- How version control supports collaboration.
- How to independently solve technical problems.

---

## Growth Marketing Application

AI tools can support growth marketing workflows by helping with:
...
This project demonstrates my ability to learn new tools and adapt workflows using AI.